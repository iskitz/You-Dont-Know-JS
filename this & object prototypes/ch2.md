...
With *implicit binding* as we just saw, we had to mutate the object in question to include a property on itself that referenced the function, and use that function reference property to indirectly (implicitly) bind `this` to the object.
